      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-primary-foreground/80">San Francisco Bay Area, CA</span>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              {certifications.map((cert, index) => (
                <div key={index} className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-primary-foreground/80">{cert}</span>
                </div>
              ))}
            </div>
            ...
            <div className="mt-6">
              ...
              <div className="flex flex-wrap gap-2">
                <Badge variant="secondary" className="bg-primary-foreground/10 dark:bg-primary-foreground/15 text-primary-foreground border-primary-foreground/20 transition-colors duration-300">
        ...
        <div className="mt-6 text-center">
          <p className="text-xs text-primary-foreground/50">
            Licensed to practice law in California. IT auditing services provided in compliance with professional standards.
          </p>
        </div>
      </div>
    </footer>
